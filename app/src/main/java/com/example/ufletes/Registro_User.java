...
public class Registro_User extends AppCompatActivity implements View.OnClickListener{
    ...
    private EditText mtxtEmail_User;
    ...
    private String Email_User_Register = "";
    ...
    private void RegistroUser() {
        mAuth.createUserWithEmailAndPassword(Email_User_Register, Password_User_Register).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            @Override
    ...
    public void onClick(View view) {
        ...
        if(!Nombre_User_Register.isEmpty() ||
            ...
            if(Password_User_Register.length() >= 6) {
                if (ConfirmPassword_User_Register != Password_User_Register) {
